...
class ModelCatalogProduct extends Model {
	...
	public function getProductAttributes($product_id) {
        ...
        public function getOption($product_id, $options) {
...
//                    $product_option1[$product_option_value['product_option_value_id']] = $product_option_value;
//                }
			foreach ($query->rows as $product_option_value) {
//                            var_dump($product_option_value);
//                            die();
                            if(in_array($product_option_value['product_option_value_id'], $options)){
				$product_option_data[] = array(
...
//                die();
	...
	public function getProductOptions($product_id) {
		...
		$product_option_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_option po LEFT JOIN `" . DB_PREFIX . "option` o ON (po.option_id = o.option_id) LEFT JOIN " . DB_PREFIX . "option_description od ON (o.option_id = od.option_id) WHERE po.product_id = '" . (int)$product_id . "' AND od.language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY o.sort_order");
//                var_dump($product_option_query);die();
		foreach ($product_option_query->rows as $product_option) {
