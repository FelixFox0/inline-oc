    ...
    <div class="container">
        <div class="manual">
            ...
            <div class="manual__categories">
                <div class="manual__categories-row">
                    <?php foreach ($blogs as $blog) { ?>
                        <a href="<?php echo $blog['href']; ?>" class="manual__categories-item">
                            <span class="manual__categories-img-wrap">
                                <img src="<?php echo $blog['image']; ?>" class="manual__categories-img" alt="<?php echo $blog['title']; ?>">
                            </span>
                            <h3 class="manual__categories-item-title"><?php echo $blog['title']; ?></h3>
                        </a>
                    <?php } ?>
                </div>
            </div>
            ...
            <?php } ?>
                ...
                <div class="manual__article-title"><?php echo $heading_title; ?></div>
                <div class="manual__article-body"><?php echo $description; ?></div>
            </article>
        </div>
    </div>
</div>
