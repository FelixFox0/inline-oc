...
//        die();
            ...
            $data['firstname'] = ($this->request->post['name']) ? ($this->request->post['name']) : 'default';
            ...
            if(isset($product_info['special'])){
                ...
                $option = $this->model_catalog_product->getOption($this->request->get['product_id'], explode(',', $this->request->post['option']));
//                var_dump($option);
...
//            $json['success'] = $order_id;
            ...
            $this->response->setOutput(json_encode($json));
                ...
                $json['success'] = $this->url->link('error/not_found');
            }
...
//			if ((utf8_strlen($this->request->post['name']) <= 0) || (utf8_strlen($this->request->post['name']) > 30)) {
//				$this->error['name'] = $this->language->get('error_name');
//			}
			
			if ((utf8_strlen($this->request->post['phone']) <= 0) || (utf8_strlen($this->request->post['phone']) > 30)) {
				$this->error['phone'] = $this->language->get('error_name');
			}
